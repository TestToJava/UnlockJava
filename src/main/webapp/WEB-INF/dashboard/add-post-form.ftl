        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <form class="form-horizontal" action="${springMacroRequestContext.contextPath}/dashboard/add-post" method="post" name="post">
                        <fieldset>
                            <div class="form-group">
                                <label class="col-md-4 control-label" for="post_title"></label>  
                                <div class="col-sm-12">
                                    <input id="post_title" name="post_title" class="form-control input-md" required="" type="text">
                                    </div>
                                </div>
                            <div class="form-group">
                                <label class="col-md-4 control-label" for="post_title"></label>  
                                <div class="col-sm-12">
                                    <textarea name="post_content" id="txtEditor"></textarea> 
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-12">
                                    <input id="post_tags" name="post_tags" class="form-control input-md" type="text">
                                    </div>
                                </div>
                            <div class="form-group">
